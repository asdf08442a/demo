...
public class PoiExcelUtils {
    ...
    /** 日志 */
    private static final Logger log                 = LoggerFactory.getLogger(PoiExcelUtils.class);
    /** 列默认宽度 */
    ...
    private HSSFSheet getHSSFSheet(HSSFWorkbook hssfWorkbook, String sheetName) {
        log.info("【创建 sheet】sheetName ： " + sheetName);
    ...
    private void write2FilePath(HSSFWorkbook hssfWorkbook, String filePath) {
        ...
        try {
            ...
            log.error("【将生成的Excel输出到指定目录失败】", e);
    ...
    public static void createExcel2FilePath(String sheetName, String title, String filePath, String[] headers, List<?> dataList) throws Exception {
        ...
        log.info("【生成Excel,并存放到指定文件夹目录下】sheetName : " + sheetName + " , title : " + title + " , filePath : " + filePath + " , headers : "
    ...
    public static void createExcel2FilePath(String sheetName, String title, String filePath, String[] mainDataFields, Object mainData,
        ...
        if (ArrayUtils.isEmpty(headers)) {
            log.warn("【参数headers为空】");
            throw new IllegalArgumentException("headers");
        }
        if (ArrayUtils.isEmpty(mainDataFields)) {
            log.warn("【参数mainDataFields】");
    ...
    private int writeMainData(HSSFWorkbook hssfWorkbook, HSSFSheet hssfSheet, int columnSize, String[] mainDataFields, Object mainData,
        ...
        LogUtils.info(log, "【写主表（mainData）数据】columnSize = {} , mainDataFields = {} , mainData = {}", columnSize, Arrays.toString(mainDataFields),
            mainData);
    ...
    private void writeExportDate(HSSFWorkbook hssfWorkbook, HSSFRow row, int cellIndex) {
        ...
        cellValueHandler(cell4ExportDateValue, DateUtils.getTimeStampYmd());
    ...
    public static HSSFWorkbook createExcel2Export(String sheetName, String title, String[] headers, List<?> dataList) throws Exception {
        ...
        log.info("【生成Excel的WorkBook，用于导出Excel】sheetName : " + sheetName + " , title : " + title + "  , headers : " + Arrays.toString(headers));
        PoiExcelUtils poiExcelUtil = new PoiExcelUtils();
        // 1.创建 Workbook
        HSSFWorkbook hssfWorkbook = poiExcelUtil.getHSSFWorkbook();
        // 2.创建 Sheet
    ...
    public static HSSFWorkbook createExcel2Export(String sheetName, String title, String[] mainDataFields, Object mainData, String[] headers,
        ...
        log.info("【生成Excel,用于导出】sheetName : " + sheetName + " , title : " + title + " , headers : " + Arrays.toString(headers)
    ...
    public static List<String[]> readExcel(String excelPath, int skipRows, int columnCount, int sheetNo,
                                           ...
                                           List<String> noneCellValuePositionList) throws Exception {
        LogUtils.info(log, "【读取Excel】excelPath = {} ， skipRows = {} , columnCount = {} , columnNumberForSkipValueValidateSet = {}", excelPath,
            skipRows, columnCount, columnNumberForSkipValueValidateSet);
