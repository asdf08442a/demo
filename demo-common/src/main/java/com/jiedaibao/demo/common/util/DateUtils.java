...
import com.jiedaibao.demo.common.enums.DateStyle;
import com.jiedaibao.demo.common.enums.Week;
...
public class DateUtils {
     ...
     * @return
     */
    public static String getTimeStampYmd(Date date) {
     ...
     */
    public static String getTimeStampYmdhmsS() {
     ...
     * 时间戳HHmmssSSS
     */
    public static String getTimeStampHmsS() {
        return dateToString(new Date(), DateStyle.HHMMSSSSS);
    }
     ...
     * @return
     */
    public static String getTimeStampHm() {
        return dateToString(new Date(), DateStyle.HHMM);
    }
